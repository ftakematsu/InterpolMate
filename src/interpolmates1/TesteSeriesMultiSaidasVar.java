...
public class TesteSeriesMultiSaidasVar {
    ...
    public static double temp_min[], temp_max[], par_geral[], rfr_geral[];
...
//            }
    ...
    public static void main(String[] args){
                ...
                int tamanho_camada_oculta = tamanho_entrada + 3; // HECHT - NIELSEN
                ...
                for (int j=0; j<qtd_comb; j++)
                {
                        ...
                        dados_treinamento[t][6] = par[j];
                        dados_treinamento[t][7] = rfr[j];
                        t++;
                    //}
                }
                ...
                double saida_rede_teste[][] = new double[100][100];
                
                final int tipo_stress = 0;
                ...
                for (int j=0; j<25; j++)
                {
                        dados_treinamento2[j][0] = uc[j];
                        dados_treinamento2[j][1] = tmin_teste[j];
                        dados_treinamento2[j][2] = tmax_teste[j];
                        dados_treinamento2[j][3] = rainfall_teste[j];
                        dados_treinamento2[j][4] = gdd_teste[j];
                        dados_treinamento2[j][5] = nl_teste[j];
                        dados_treinamento2[j][6] = par_teste[j];
                        dados_treinamento2[j][7] = rfr_teste[j];
                 }
